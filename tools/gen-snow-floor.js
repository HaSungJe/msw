// 엘나스 눈 바닥 — 256px 무이음새, 흰색 램프 (gen-cave-floor.js 노이즈 구조 재사용)
...
// 눈 램프 — 푸른 그림자에서 순백까지 (2026-08-18 사용자 지시: 엘나스 눈, 하얗게)
const stops = [
  [206, 216, 230],  // 그늘진 눈(옅은 푸른빛)
  [226, 234, 244],
  [241, 245, 250],
  [253, 254, 255],  // 볕 받은 눈
];
