...
| `elnath-snow.png` | 엘나스 눈(흰색) — 2026-08-18 확정, 09-14 헤네시스로 교체 | `tools/gen-snow-floor.js` | `df8df44de6e64c25a74f465ef88ef4c8` (ElnathSnowFloor) | 보관 |
...
| (눈 배경판) | 같은 경로, 회청 선·회청 발판(엘나스 눈 위 용) | `tools/gen-track-grid.js` (색만 다름) | `651583e1c1ee44cdb6d2a891755ab528` (ZoneTrackGrid) | 보관 |
...
3. 참조처 교체
   - 바닥: `RootDesk/MyDesk/CaveFloorTileSet.tileset`의 `datas[0].Id`
   - 트랙: `RootDesk/MyDesk/RtsZoneLogic.GridRUID`
