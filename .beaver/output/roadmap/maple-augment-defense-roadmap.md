...
지금: **유닛 정보 팝업 + 캐릭터 선택·위치 이동 (2026-09-15, 화면 v2 위에 추가 — Phase 4 #14·#17, Phase 5 #19·#20, Phase 2 #6을 시범 3직업으로 선행 구현. report: `screen-v2-report.md` Change 260915-1)** · Next up: Phase 2 나머지(스테이지·경제 표) → Phase 3
